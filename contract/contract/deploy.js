...
DLP_TOKEN_SYMBOL=${DLP_TOKEN_SYMBOL}
  ...
  // Step 5: Create a simple deploy script inline (scripts/dlp-deploy.ts)
  const deployScript = `
...
async function main() {
  ...
  const DLPToken = await ethers.getContractFactory("DLP"); // Make sure "DLP" is the correct contract name
